...
public final class ShareUtils
{
	...
	public static void sharePhoto(Context context, String filePath)
	{
        ...
        if (cursor == null) {
            ...
            int contentTypeColumn = cursor.getColumnIndex(Images.Media.MIME_TYPE);
            do {
	...
	public static void shareVideo(Context context, String filePath)
	{
        ...
        if (cursor == null) {
            ...
            int idColumn = cursor.getColumnIndex(Video.Media._ID);
            int contentTypeColumn = cursor.getColumnIndex(Video.Media.MIME_TYPE);
            do {
                id = cursor.getLong(idColumn);
                String contentType = cursor.getString(contentTypeColumn);
